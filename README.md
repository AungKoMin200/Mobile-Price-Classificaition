...
The dataset used in this project is the Mobile Price Classification dataset from Kaggle. It contains 2,000 samples with 21 features (20 input features and 1 target variable).
